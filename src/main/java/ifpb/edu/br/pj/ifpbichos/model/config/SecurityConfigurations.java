	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		return  httpSecurity
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers(HttpMethod.POST, "/api/campaign").permitAll()
						.requestMatchers(HttpMethod.GET, "/api/campaign").permitAll()
						.requestMatchers(HttpMethod.GET, "/api/campaign/{id}").permitAll()
						.requestMatchers(HttpMethod.PUT, "/api/campaign/{id}").permitAll()
						.requestMatchers(HttpMethod.DELETE, "/api/campaign/{id}").permitAll()
